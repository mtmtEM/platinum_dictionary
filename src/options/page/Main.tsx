...
const initialState: MainState = {
  ...
  previewText: "IP spoofing attack",
  panelLevel: 0,
  lang: "",
  initialized: false,
};
  ...
  return (
    <>
      <div style={{ textAlign: "center", marginBottom: "10px" }}>
        <ExternalLink href="https://github.com/mtmtEM/platinum_dictionary">
      ...
      <div>
        ...
        <Panel active={!state.busy && !env.disableUserSettings && state.initialized}>
          ...
          <ExternalLink href="https://github.com/wtetsu/mouse-dictionary">
            {res.get("originalExtension")}
          </ExternalLink>
          <br />
          <ExternalLink href="pdf/web/viewer.html">{res.get("openPdfViewer")}</ExternalLink>
          <br />
          <ExternalLink href="../dictionary/dictionary.html">
            {res.get("wordsLookUp")}
          </ExternalLink>
