...
export default {
  ...
  htmlTemplateWindow: "Platinum Dictionaryウィンドウ全体",
  ...
  originalExtension: "オリジナルの拡張「Mouse Dictionary」",
  ...
  aboutJsonEditor:
    "Platinum Dictionary設定全体のJSONデータです。バックアップや共有にご利用ください ※辞書データは含みません",
