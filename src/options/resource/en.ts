...
export default {
  ...
  htmlTemplateWindow: "Platinum Dictionary window frame",
  ...
  originalExtension: "Referred from 「Mouse Dictionary」",
  ...
  aboutJsonEditor:
    "This is JSON data which expresses the whole Platinum Dictionary's settings. Please use it for backup, sharing and so forth.",
  ...
  wordsLookUp: "Look up in the dictionary",
};
