...
const resources = {
  ja: {
    continueProcessingPdf:
      "このPDFファイルをダウンロードし、Platinum Dictionaryの内部ビューアで表示します。よろしいですか？\n(設定画面で、この確認ダイアログ表示をオフにすることもできます)",
    doesntSupportFrame: "Platinum Dictionaryは、フレームのあるページで使用することはできません。",
  ...
  en: {
    continueProcessingPdf:
      "Are you sure you want to download this PDF file and show it with Platinum Dictionary's internal viewer?\n(You can turn off this confirmation permanently by changing settings)",
    doesntSupportFrame: "Platinum Dictionary doesn't support frame pages.",
